...
import VisitAndEarnFirstForm from './VisitAndEarnFirstForm';
import VisitAndEarnSecondForm from './VisitAndEarnSecondForm';
import VisitAndEarnThirdForm from './VisitAndEarnThirdForm';
  ...
  const steps = [
    {
      ...
      content: <VisitAndEarnFirstForm form={form1} />,
    },
    {
      title: "Rewards Setup Form",
      content: <VisitAndEarnSecondForm form={form2} />,
    },
    {
      title: "Rewarded Items Form",
      content: <VisitAndEarnThirdForm form={form3} />,
    },
  ];
