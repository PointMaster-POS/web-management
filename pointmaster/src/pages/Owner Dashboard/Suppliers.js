...
const Suppliers = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      key: 'orders',
      render: (text, record) => (
        <Button className='view-order-btn' onClick={() => handleViewOrders(record.supplier_id)}>
          View Orders
        </Button>
      ),
    },
    ...
    <Content className="content">
        ...
        <div className="header">
          ...
          <Space className='header-right-end'>
            <Search 
              ...
              value={searchText}
            />
            <Button className='addsup-btn' type="primary" onClick={handleAddSupplierClick}>
              Add Suppliers
            </Button>
          </Space>
        </div>
      ...
      <Modal
        ...
        footer={[
          ...
          <Button className='save-btn' key="save" type="primary" onClick={handleModalSave}>
            Save
          </Button>,
        ]}
      >
